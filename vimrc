...
" set foldlevel=100000000000            " 禁止自动折叠
set nofoldenable
...
nmap <F3> :NERDTreeToggle<CR> <C-H>
imap <F4> <ESC>:w<CR>
nmap <F4> :w<CR>
nmap <C-LEFT> :bp<CR> 
nmap <C-RIGHT> :bn<CR> 
nmap <C-DELETE> :bd<CR>
" https://github.com/ianva/vim-youdao-translater.git ,有道翻译的配置
vnoremap <silent> <C-T> <Esc>:Ydv<CR> 
nnoremap <silent> <C-T> <Esc>:Ydc<CR> 
noremap <leader>yd :Yde<CR>
map <C-RIGHT> :bn<CR>

vmap ; <ESC> :call PatternExtract()<CR>

function PatternExtract()
    :'<,'> j
    :.w >>b
    :normal jn
endfunction
" function PatternExtract()
    " let n=search("研究所","W")
    " while n>0
        " let colu=inputlist("Col:")
        " if colu>0 && colu <15
            " :execute eval(0-colu) . "," . line('.') . "j"
            " :.w >>b
            " :normal j
            " :call cursor(line('.'),0)
        " endif
